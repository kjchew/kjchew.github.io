                ...
                <form class="col s12">
                    <div class="row">
                        <div class="input-field col s6">
                            <input id="emailName" type="text" v-model="metadataEditInput.emailName">
                        </div>
                        <div class="input-field col s6">
                            <input id="campaignTag" type="text" v-model="metadataEditInput.campaignTag">
                        </div>
                    </div>
                </form>
            </div>
...
export default {
    ...
    methods: {
        ...
        update(){
            ...
            this.updateMetadata(this.metadataEditInput.index, this.metadataEditInput.emailName, this.metadataEditInput.campaignTag);
        }
    },
}
</script>
